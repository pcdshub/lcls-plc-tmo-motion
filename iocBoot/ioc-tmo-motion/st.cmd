...
epicsEnvSet("ADS_MAX_PARAMS",   "15081")
...
epicsEnvSet("MOTOR_PREFIX",    "CF1K4:MMS:")
epicsEnvSet("MOTOR_NAME",      "FILT")
epicsEnvSet("DESC",            "Main.M47 / Axis 47 CF1K4-MMS-FILT")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
#   lcls-twincat-common-components: * -> 3.4.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TMO:MOTION,DEPENDENCY=lcls-twincat-common-components,VERSION=3.4.0,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 4.0.7 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TMO:MOTION,DEPENDENCY=lcls-twincat-motion,VERSION=4.0.7,VENDOR=SLAC")
#   PMPS: * -> 3.0.14 (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TMO:MOTION,DEPENDENCY=PMPS,VERSION=3.0.14,VENDOR=SLAC - LCLS")
#   Tc2_MC2: * -> 3.3.42.0 (Beckhoff Automation GmbH)
