...
epicsEnvSet("LOCATION", "PLC:TMO:PROTO7" )
...
epicsEnvSet("PREFIX",         "PLC:TMO:PROTO7:")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "Axis:1:AL1K4-L2SI-MMS")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "Axis:6:IM1K4-XTES-MMS")
epicsEnvSet("DESC",            "Main.M6 / Axis 6 IM1K4-XTES-MMS")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "Axis:7:IM1K4-XTES-CLZ")
epicsEnvSet("DESC",            "Main.M7 / Axis 7 IM1K4-XTES-CLZ")
epicsEnvSet("EGU",             "%")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "Axis:8:IM1K4-XTES-CLF")
epicsEnvSet("DESC",            "Main.M8 / Axis 8 IM1K4-XTES-CLF")
epicsEnvSet("EGU",             "%")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "SL1K4-BOTTOM-M10")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "SL1K4-TOP-M11")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "SL1K4-NORTH-M12")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "SL1K4-SOUTH-M13")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:TMO:PROTO7:")
epicsEnvSet("MOTOR_NAME",      "ST1K4-TEST")
...
epicsEnvSet("MOTOR_PREFIX",    "TST:IM3K4:PPM:")
...
epicsEnvSet("MOTOR_PREFIX",    "TST:IM4K4:PPM:")
epicsEnvSet("MOTOR_NAME",      "MMS")
...
epicsEnvSet("MOTOR_PREFIX",    "TST:IM5K4:PPM:")
epicsEnvSet("MOTOR_NAME",      "MMS")
...
epicsEnvSet("MOTOR_PREFIX",    "TST:LI1K4:IP1:")
epicsEnvSet("MOTOR_NAME",      "MMS")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:TMO:PROTO7")
dbLoadRecords("save_restoreStatus.db", "P=PLC:TMO:PROTO7:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:TMO:PROTO7")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:TMO:PROTO7")
...
save_restoreSet_status_prefix( "PLC:TMO:PROTO7:" )
